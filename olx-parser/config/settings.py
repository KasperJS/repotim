...
class settings:
    ...
    CATEGORY = env.str('CATEGORY', default=None)
    SUB_CATEGORY = env.str('SUB_CATEGORY', default=None)
    SUB_SUB_CATEGORY = env.str('SUB_SUB_CATEGORY', default=None)
    CITY = env.str('CITY', default="")
    DISTRICT_ID = env.int('DISTRICT_ID', default=None)
    MIN_PRICE = env.int('MIN_PRICE', default=0)
    MAX_PRICE = env.int('MAX_PRICE', default=0)
    MIN_ROOMS = env.int('MIN_ROOMS', default=0)
    MAX_ROOMS = env.int('MAX_ROOMS', default=0)
